...
$(document).ready(function(){
  ...
  /*$('#eef-feedback-close').click(function(){
    $('#eef-feedback,#eef-feedback-close').hide();
  });*/

  //home page header link
  $('a[data-value=\"equality\"]').click(function(){
    if(policyEquality != 'grid') {
      window.history.pushState({equality: '', policy: ''}, null, null);
    }
  ...
  $('.eef-grid-square,.eef-grid-summ,.eef-mobile-grid.sub').click(function(){
    ...
    if(policyEquality!=policy+'_'+equality) {
      window.history.pushState({equality: equality, policy: policy}, null, null);
    }
