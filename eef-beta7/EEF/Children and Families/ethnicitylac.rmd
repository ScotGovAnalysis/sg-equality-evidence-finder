...
LAC_pc_unknown <- round(filter(EEFlatest, Measure == "% young people looked after by ethnic group, 31st July",
                                      Characteristic == "Ethnicity", Breakdown == "Unknown")$Figure,1)


#create the latest year's data for the % of looked after children with an ethnicity recorded as white (no edit needed)

LAC_pc_white <- round(filter(EEFlatest, Measure == "% young people looked after by ethnic group, 31st July",
                                      Characteristic == "Ethnicity", Breakdown == "White")$Figure,1)

#create the latest year's data for the % of looked after children with an ethnicity recorded as white (no edit needed)

LAC_pc_other <- round(filter(EEFlatest, Measure == "% young people looked after by ethnic group, 31st July",
