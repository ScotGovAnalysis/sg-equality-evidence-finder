...
latestyear <- filter(EEFlatest, Measure == "Count of Early Learning and Childcare registrations, September",
                            Characteristic == "Age")$Year[1]


#create the last year as a variable (no edit needed)

lastyear <- filter(EEFdata, Measure == "Count of Early Learning and Childcare registrations, September",
...
Count_of_elc_latest <- as.numeric(filter(EEFlatest, Measure == "Count of Early Learning and Childcare registrations, September",
...
Count_of_elc_last <- as.numeric(filter(EEFdata, Measure == "Count of Early Learning and Childcare registrations, September",
...
* In `r latestyear`, there were `r Count_elc_latest` registrations for early learning and childcare in Scotland.
	...
	Most registrations are for 3 and 4 year olds, with smaller numbers of 2 year olds and under and children who defer entry to
	primary school.
