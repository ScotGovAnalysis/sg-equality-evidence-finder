...
CP_pc_with_religion <- round(filter(EEFlatest, Measure == "% young people on the child protection register by religion, 31st July",
...
CP_pc_no_religion <- round(filter(EEFlatest, Measure == "% young people on the child protection register by religion, 31st July",
...
CP_pc_religion_unknown <- round(filter(EEFlatest, Measure == "% young people on the child protection register by religion, 31st July",
