...
latestyear <- max(filter(EEFdata, Measure == "% Early Learning and Childcare registrations with a home language other than English, September", Characteristic == "Ethnicity")$Year)


#create the first year as a variable (no edit needed)

firstyear <- min(filter(EEFdata, Measure == "% Early Learning and Childcare registrations with a home language other than English, September", Characteristic == "Ethnicity")$Year)


#create the latest year's data for the % of elc registrations with a home language other than english (no edit needed)

ELC_lang_latest <- round(filter(EEFdata, Measure == "% Early Learning and Childcare registrations with a home language other than English, September", Characteristic == "Ethnicity", Breakdown == "All", Year == latestyear)$Figure,1)

#create the latest year's data for the % of elc registrations with a home language other than english (no edit needed)

ELC_lang_first <- round(filter(EEFdata, Measure == "% Early Learning and Childcare registrations with a home language other than English, September", Characteristic == "Ethnicity", Breakdown == "All", Year == firstyear)$Figure,1)
