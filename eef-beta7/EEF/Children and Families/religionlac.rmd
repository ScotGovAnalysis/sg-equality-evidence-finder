...
LAC_pc_with_religion <- round(filter(EEFlatest, Measure == "% young people looked after by religion, 31st July",
...
LAC_pc_no_religion <- round(filter(EEFlatest, Measure == "% young people looked after by religion, 31st July",
...
LAC_pc_religion_unknown <- round(filter(EEFlatest, Measure == "% young people looked after by religion, 31st July",
