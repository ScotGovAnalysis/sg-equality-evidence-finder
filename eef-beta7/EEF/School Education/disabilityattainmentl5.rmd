...
latestyear <- as.character( filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 5 or better",
                                   Characteristic == "Disability")$label[1] )

#create the asn and no asn figures (no edit needed)

asn <- round(as.numeric(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 5 or better",
                            Characteristic == "Disability",  Breakdown == "ASN", Year == max(Year))$Figure),1)

noasn <- round(as.numeric(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 5 or better",
...
* School leavers with additional support needs in `r latestyear`, continued to have lower attainment, with `r asn` per cent of pupils 
	with an additional support need achieving one or more passes at SCQF Level 5 or  better compared to `r noasn` per cent for 
