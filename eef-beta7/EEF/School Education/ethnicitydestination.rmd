...
ethnic_data <- filter(School_Education, Measure == "% school leavers in a positive follow-up destination",
...
scottish_fig <- round(filter(School_Education, Measure == "% school leavers in a positive follow-up destination",
...
* In `r latestyear`, `r ethnic_fig` per cent of school leavers who identified their ethnicity as `r ethnic_name` were in a positive 
	follow-up destination, compared to `r scottish_fig` per cent for leavers with an ethnicity of White-Scottish.
