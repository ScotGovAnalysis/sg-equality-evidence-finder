...
`r totmedian <- filter(graphData, Year == max(Year), Breakdown == "Total", Characteristic == "Gender") %>% select(Figure)`
...
* Pensioner couples were the wealthiest on average, lone parents the least wealthy. Differences between male and female single adult households with no children were fairly small.
