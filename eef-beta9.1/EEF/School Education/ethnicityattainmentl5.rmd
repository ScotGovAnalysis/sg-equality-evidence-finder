...
ethnic_data <- filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 5 or better",
...
scottish_fig <- round(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 5 or better",
...
* In `r latestyear`, school leavers who identified their ethnicity as `r ethnic_name` had the highest levels of attainment with
	`r ethnic_fig` per cent of leavers achieving one or more passes at SCQF Level 5 or better, far higher than the percentage 
