...
latestyear <- as.character( filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 6 or better",
                            Characteristic == "Ethnicity", Year == max(Year))$label[1] )

#create the highest figure data year's data for ethnicity (no edit needed)

ethnic_data <- filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 6 or better",
...
scottish_fig <- round(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 6 or better",
...
* In `r latestyear`, school leavers who identified their ethnicity as `r ethnic_name` had the highest levels of attainment with
	`r ethnic_fig` per cent of leavers achieving one or more passes at SCQF Level 6 or better, far higher than the percentage 
