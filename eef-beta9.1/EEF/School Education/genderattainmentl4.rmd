...
female_percent <- round(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 4 or better",
                               Characteristic == "Gender", Breakdown == "Female")$Figure,1)

#create the latest year's data for female's (no edit needed)

male_percent <- round(filter(School_Education, Measure == "% school leavers achieving 1 or more passes at SCQF Level 4 or better",
...
* In `r latestyear` female school leavers had the highest levels of attainment with 
      `r female_percent` per cent achieving one or more passes at SCQF Level 4 or better, compared to 
